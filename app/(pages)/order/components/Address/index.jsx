        ...
        <section className="xl:h-[336px] h-auto w-full rounded-[15px] bg-white py-[24px] shadow-[0px_0px_8px_0px_#AFAFAF14]">
          ...
          <section className="mt-6 flex flex-col gap-2 w-[85%] mx-auto  xl:px-6">
            ...
            <ItemsList
              ...
              title="تهران - پیروزی"
            />
            <button className="text-[#700B97] xl:text-base text-sm flex items-center justify-center gap-[10px] mt-[25px] rounded-lg h-[48px] border border-solid border-[#700B97]">
            <Image
              alt=""
              width={14}
              height={17.75}
