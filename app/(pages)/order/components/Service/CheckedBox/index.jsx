    ...
    <>
      ...
      >
        <section className="flex items-center gap-4">
          ...
          <section
            className={`flex text-sm xl:text-base gap-1 ${serviceType.includes(value) ? "dark:text-white text-[#700B97]" : "dark:text-[#a590ad] text-[#222222]"}`}
          >
            {title}
          </section>
        </section>
        ...
        <span
          className={`justify-self-end text-xs ${serviceType.includes(value)? "dark:text-white text-[#700B97]" : "dark:text-[#a590ad] text-[#222222]"}`}
        >
          {price}
        </span>
      </section>
