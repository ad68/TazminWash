...
export default function Index() {
  ...
  //
  return <>
   <section className="mx-auto mt-[64px] flex h-[40px] overflow-hidden w-fit justify-between rounded-[10px] border  border-solid border-[#E5E7EB] text-[#6B7280] shadow-[0px_1px_2px_0px_#0000000D] dark:text-white">
