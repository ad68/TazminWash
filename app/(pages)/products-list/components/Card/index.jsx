...
export default function Index({ title, text, img, price,display,discount,discountPercent,oldPrice }) {
  // ─── Global Variable ────────────────────────────────────────────────────────────
  ...
  return (
    <>
      <section className={`${display} dark:bg-slider-gradient  flex h-auto w-full xl:w-[306px] flex-col rounded-2xl  border-[1px] border-solid border-[#ffffff1a]  bg-white p-[10px] xl:p-4 text-[#0C0C0C] shadow-2xl dark:text-white`}>
        ...
        <section className="xl:mt-8 mt-4 flex xl:flex-row  w-full items-end xl:items-center justify-between">
