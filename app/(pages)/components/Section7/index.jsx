...
export default function Index() {
  ...
  return (
    <>
      <section className="xl:mt-[120px] mt-[40px] mx-auto w-[90%] xl:w-full xl:h-[580px] h-[337px]">
        ...
        <section className="xl:hidden mt-6 h-[278px] -z-10 rotate-6 absolute  rounded-[15px] shadow-[0px_4px_8px_0px_#0000000F,0px_0px_4px_0px_#0000000A] dark:shadow-[0px_4px_8px_0px_#0000000F,0px_0px_4px_0px_#0000000A] dark:bg-white xl:h-[580px] w-[90%] mx-auto justify-items-center gap-4  bg-cover  ">
     
        </section>
        <section className="xl:hidden mt-6  dark:bg-white h-[278px] z-0 rotate-3  absolute rounded-[15px] shadow-[0px_4px_8px_0px_#0000000F,0px_0px_4px_0px_#0000000A] xl:h-[580px] w-[90%] mx-auto justify-items-center gap-4  ">
