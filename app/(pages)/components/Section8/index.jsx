    ...
    <>
      <section className="mx-auto mt-[40px] xl:mt-[120px] xl:w-[1296px] w-[95%] grid gap-[25px]">
        ...
        <section className=" flex gap-6 justify-center">
            ...
            <Card display='hidden' image={"/images/article2.png"} title={"تاثیر تمیزی خودرو بر استحکام و طول عمر قطعات"} text={"تمیزی و نگهداری مناسب خودرو، علاوه بر بهبود ظاهر و استحکام آن، تأثیر بسزایی در ایجاد اعتماد و رضایت مشتریان دارد و... "} date={'1403/02/02'}/>
          
                
            <Card display='hidden' image={"/images/article3.png"} title={"تاثیر تمیزی خودرو بر استحکام و طول عمر قطعات"} text={"تمیزی و نگهداری مناسب خودرو، علاوه بر بهبود ظاهر و استحکام آن، تأثیر بسزایی در ایجاد اعتماد و رضایت مشتریان دارد و... "} date={'1403/02/02'}/>
            <Card display='hidden' image={"/images/article4.png"} title={"تاثیر تمیزی خودرو بر استحکام و طول عمر قطعات"} text={"تمیزی و نگهداری مناسب خودرو، علاوه بر بهبود ظاهر و استحکام آن، تأثیر بسزایی در ایجاد اعتماد و رضایت مشتریان دارد و... "} date={'1403/02/02'} />
